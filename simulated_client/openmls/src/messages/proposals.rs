...
impl From<u16> for ProposalType {
    fn from(value: u16) -> Self {
        match value {
            ...
            9 => ProposalType::AddReqs,
            10 => ProposalType::UpdateReqs,
            11 => ProposalType:: RemoveReqs,
...
impl From<ProposalType> for u16 {
    fn from(value: ProposalType) -> Self {
        match value {
            ...
            ProposalType::AddReqs => 9,
            ProposalType::UpdateReqs => 10,
            ProposalType::RemoveReqs => 11,
...
impl Proposal {
    ...
    pub fn proposal_type(&self) -> ProposalType {
        match self {
            ...
            Proposal::AddReqs(_) => ProposalType::AddReqs,
            Proposal::UpdateReqs(_) => ProposalType::UpdateReqs,
            Proposal::RemoveReqs(_) => ProposalType::RemoveReqs,
...
pub struct AddReqsProposal {
    pub(crate) new_req: VLBytes,
}

#[derive(
    Debug, PartialEq, Eq, Clone, Serialize, Deserialize, TlsDeserialize, TlsSerialize, TlsSize,
)]
pub struct UpdateReqsProposal {
    pub(crate) index: u32,
    pub(crate) new_req: VLBytes,
}

impl UpdateReqsProposal {
    /// Returns the leaf index of the removed leaf in this proposal.
...
pub struct RemoveReqsProposal {
    pub(crate) index: u32,
}

impl RemoveReqsProposal {
    /// Returns the leaf index of the removed leaf in this proposal.
