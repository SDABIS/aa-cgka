    ...
    fn tls_serialized_len(&self) -> usize {
        self.proposal_type().tls_serialized_len()
            + match self {
                ...
                Proposal::AddReqs(p) => p.tls_serialized_len(),
                Proposal::UpdateReqs(p) => p.tls_serialized_len(),
                Proposal::RemoveReqs(p) => p.tls_serialized_len(),
...
impl Serialize for Proposal {
    fn tls_serialize<W: std::io::Write>(&self, writer: &mut W) -> Result<usize, tls_codec::Error> {
        ...
        match self {
            ...
            Proposal::AddReqs(p) => p.tls_serialize(writer),
            Proposal::UpdateReqs(p) => p.tls_serialize(writer),
            Proposal::RemoveReqs(p) => p.tls_serialize(writer),
    ...
    fn tls_serialized_len(&self) -> usize {
        self.proposal_type().tls_serialized_len()
            + match self {
                ...
                ProposalIn::AddReqs(p) => p.tls_serialized_len(),
                ProposalIn::UpdateReqs(p) => p.tls_serialized_len(),
                ProposalIn::RemoveReqs(p) => p.tls_serialized_len(),
...
impl Serialize for &ProposalIn {
    fn tls_serialize<W: std::io::Write>(&self, writer: &mut W) -> Result<usize, tls_codec::Error> {
        ...
        match self {
            ...
            ProposalIn::AddReqs(p) => p.tls_serialize(writer),
            ProposalIn::UpdateReqs(p) => p.tls_serialize(writer),
            ProposalIn::RemoveReqs(p) => p.tls_serialize(writer),
...
impl Deserialize for ProposalIn {
        ...
        Self: Sized,
    {
        ...
        let proposal = match proposal_type {
            ...
            ProposalType::AddReqs => ProposalIn::Add(AddProposalIn::tls_deserialize(bytes)?),
            ProposalType::UpdateReqs => ProposalIn::Update(UpdateProposalIn::tls_deserialize(bytes)?),
            ProposalType::RemoveReqs => ProposalIn::Remove(RemoveProposal::tls_deserialize(bytes)?),
