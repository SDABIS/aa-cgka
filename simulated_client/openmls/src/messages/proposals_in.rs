...
use crate::prelude::{AddReqsProposal, RemoveReqsProposal, UpdateReqsProposal};
use super::{
    proposals::{
...
impl From<crate::messages::proposals::Proposal> for ProposalIn {
    fn from(proposal: crate::messages::proposals::Proposal) -> Self {
        match proposal {
            ...
            Proposal::AddReqs(add) => Self::AddReqs(add.into()),
            Proposal::UpdateReqs(update) => Self::UpdateReqs(update.into()),
            Proposal::RemoveReqs(remove) => Self::RemoveReqs(remove),
