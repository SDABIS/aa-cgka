...
use crate::extensions::{ApplicationIdExtension, Extension, ExtensionType, ExternalPubExtension, ExternalSendersExtension, RatchetTreeExtension, RequiredCapabilitiesExtension, SsiVcRequirementsExtension, UnknownExtension};
...
impl Size for Extension {
    ...
    fn tls_serialized_len(&self) -> usize {
        ...
        let extension_data_len = match self {
            ...
            Extension::SsiVcRequirements(e) => e.tls_serialized_len(),
...
impl Serialize for Extension {
    fn tls_serialize<W: Write>(&self, writer: &mut W) -> Result<usize, tls_codec::Error> {
        ...
        let extension_data_written = match self {
            ...
            Extension::SsiVcRequirements(e) => e.tls_serialize(&mut extension_data),
    ...
    fn tls_deserialize<R: Read>(bytes: &mut R) -> Result<Self, tls_codec::Error> {
        ...
        Ok(match extension_type {
            ...
            ExtensionType::SsiVcRequirements => {
                Extension::SsiVcRequirements(SsiVcRequirementsExtension::tls_deserialize(&mut extension_data)?)
            }
