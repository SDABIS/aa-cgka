...
use super::proposals::{
    ...
    UpdateProposal, AddReqsProposal, UpdateReqsProposal, RemoveReqsProposal
};
...
pub enum ProposalIn {
    ...
    AddReqs(AddReqsProposal),
    #[tls_codec(discriminant = 10)]
    UpdateReqs(UpdateReqsProposal),
    #[tls_codec(discriminant = 11)]
    RemoveReqs(RemoveReqsProposal),
}
...
impl ProposalIn {
    ...
    pub fn proposal_type(&self) -> ProposalType {
        match self {
            ...
            ProposalIn::AddReqs(_) => ProposalType::AddReqs,
            ProposalIn::UpdateReqs(_) => ProposalType::UpdateReqs,
            ProposalIn::RemoveReqs(_) => ProposalType::RemoveReqs,
        }
    }
    ...
    pub(crate) fn validate(
        ...
        Ok(match self {
            ...
            ProposalIn::AddReqs(add_req) => Proposal::AddReqs(add_req),
            ProposalIn::UpdateReqs(update_req) => Proposal::UpdateReqs(update_req),
            ProposalIn::RemoveReqs(remove_req) => Proposal::RemoveReqs(remove_req),
        })
    }
}
...
impl From<ProposalIn> for crate::messages::proposals::Proposal {
    fn from(proposal: ProposalIn) -> Self {
        match proposal {
            ...
            ProposalIn::AddReqs(add_req) => Self::AddReqs(add_req),
            ProposalIn::UpdateReqs(update_req) => Self::UpdateReqs(update_req),
            ProposalIn::RemoveReqs(remove_req) => Self::RemoveReqs(remove_req),
        }
    }
}
...
impl From<crate::messages::proposals::Proposal> for ProposalIn {
    fn from(proposal: crate::messages::proposals::Proposal) -> Self {
        match proposal {
            ...
            Proposal::AddReqs(add_req) => Self::AddReqs(add_req),
            Proposal::UpdateReqs(update_req) => Self::UpdateReqs(update_req),
            Proposal::RemoveReqs(remove_req) => Self::RemoveReqs(remove_req),
        }
    }
}
