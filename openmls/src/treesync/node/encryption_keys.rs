...
#[derive(Clone, Serialize, Deserialize, TlsDeserialize, TlsSerialize, TlsSize, PartialEq, Eq)]
...
#[derive(Debug, Clone, Serialize, Deserialize, TlsDeserialize, TlsSerialize, TlsSize, PartialEq, Eq)]
