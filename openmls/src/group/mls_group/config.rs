...
pub struct MlsGroupConfig {
    ...
    /// SSI + VC Extension
    pub(crate) ssi_vc_requirements: SsiVcRequirementsExtension,
...
impl MlsGroupConfigBuilder {
    ...
    pub fn ssi_vc_requirements(mut self, ssi_vc_requirements: SsiVcRequirementsExtension) -> Self {
        self.config.ssi_vc_requirements = ssi_vc_requirements;
        self
    }
