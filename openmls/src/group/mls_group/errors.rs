...
pub enum EmptyInputError {
    ...
    AddMembers,
    #[error("An empty list of requirements was provided.")]
    AddReqs,
    #[error("An empty list of requirement references was provided.")]
    RemoveReqs,
...
/// Leave group error
#[derive(Error, Debug, PartialEq, Clone)]
pub enum AddReqsError<KeyStoreError> {
    /// See [`LibraryError`] for more details.
    #[error(transparent)]
    LibraryError(#[from] LibraryError),
    #[error(transparent)]
...
/// Leave group error
#[derive(Error, Debug, PartialEq, Clone)]
pub enum UpdateReqsError<KeyStoreError> {
    /// See [`LibraryError`] for more details.
    #[error(transparent)]
    LibraryError(#[from] LibraryError),
    /// See [`MlsGroupStateError`] for more details.
...
/// Leave group error
#[derive(Error, Debug, PartialEq, Clone)]
pub enum RemoveReqsError<KeyStoreError> {
    /// See [`LibraryError`] for more details.
    #[error(transparent)]
    LibraryError(#[from] LibraryError),
    #[error(transparent)]
