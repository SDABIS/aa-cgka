...
use crate::{
    ...
    extensions::{
        ...
        RequiredCapabilitiesExtension,SsiVcRequirementsExtension,
    },
...
pub(crate) struct TempBuilderPG1 {
    ...
    ssi_vc_requirements: Option<SsiVcRequirementsExtension>,
...
impl TempBuilderPG1 {
    ...
    pub(crate) fn with_ssi_vc_requirements(
        ...
        self.ssi_vc_requirements = Some(ssi_vc_requirements);
        self
    }
    ...
    pub(crate) fn get_secrets(
        ...
        if let Some(ssi_vc_requirements) = self.ssi_vc_requirements.map(Extension::SsiVcRequirements) {
            extensions.push(ssi_vc_requirements);
        }
